...
Fakes consume each platform's *real* payload shapes — 141 tests across Python + TS, zero network.
...
uv run pytest        # 106 Python tests, all offline
uv run ruff check .
cd sdks/typescript && npm ci && npm test   # 35 vitest tests
```
