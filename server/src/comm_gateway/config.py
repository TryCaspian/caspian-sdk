...
class Settings(BaseSettings):
    ...
    # Microsoft Teams (channel "teams"). Azure Bot Service app credentials;
    # per-connection credentials (app_id, app_secret) override these.
    teams_app_id: str = ""
    teams_app_secret: str = ""
    teams_base_url: str = "https://smba.trafficmanager.net/teams"
